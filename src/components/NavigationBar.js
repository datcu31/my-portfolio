            ...
            <nav>
                <ul className="flex gap-8 items-center justify-center sm:gap-20 md:gap-28">
                    <li className="transition hover:-translate-y-1">
                        <NavLink to="/" className={({ isActive }) => (isActive ? "border-b-2 border-black" : "")} end>Home</NavLink>
                    </li>
                    <li className="transition hover:-translate-y-1">
                    ...
                    <li className="transition hover:scale-110">
                        <NavLink to="/" end className="text-3xl font-semibold tracking-widest">A|D</NavLink>
                    </li>
                    <li className="transition hover:-translate-y-1">
